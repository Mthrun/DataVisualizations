...
ggplot2::ggplot(DF, mapping = ggplot2::aes_string(y = 'ITS',x='ID')) + ggplot2::geom_violin(stat = "PDEdensity",fill = "black")+ggplot2::theme_bw()+ggplot2::ylab('Range of Values')+ggplot2::xlab('PDE')

#Shortcut for several features
MTY[MTY>8000]=8000 #Disregard outliers after deeper analysis, see publication
PDEviolinplotData(cbind(ITS,MTY))
```
