...
## Mirrored Density Plots (MD-plots): PDE-Optimized Violin Plots

A clear model behind density estimation can outperform conventional visualization approaches. The approach is published in [Thrun et al. ,2019].
