...
DF=data.frame(ID=1:length(ITS),MTY=ITS)
ggplot2::ggplot(DF, mapping = ggplot2::aes_string(y = 'MTY',x='ID')) + ggplot2::geom_violin(stat = "PDEdensity",fill = "black")+ggplot2::theme_bw()+ggplot2::ylab('Range of Values')+ggplot2::xlab('PDE')

#Shortcut for several features

PDEviolinplotData(cbind(ITS,MTY[MTY<10000]))
```
...
A Shortcut to visualize correlation coefficients:
